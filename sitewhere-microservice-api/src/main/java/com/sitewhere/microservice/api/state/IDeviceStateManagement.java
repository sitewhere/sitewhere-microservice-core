...
public interface IDeviceStateManagement extends ITenantEngineLifecycleComponent {
     ...
     * @throws SiteWhereException
     */
    IDeviceState getDeviceStateByDeviceAssignmentId(UUID assignmentId) throws SiteWhereException;
     ...
     * @throws SiteWhereException
     */
    ISearchResults<IDeviceState> searchDeviceStates(IDeviceStateSearchCriteria criteria) throws SiteWhereException;
