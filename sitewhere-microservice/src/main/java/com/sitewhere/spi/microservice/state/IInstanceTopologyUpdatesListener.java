...
public interface IInstanceTopologyUpdatesListener {
     ...
     * @param microservice
     */
    void onMicroserviceAdded(IMicroserviceState microservice);
     ...
     * @param updated
     */
    void onMicroserviceUpdated(IMicroserviceState previous, IMicroserviceState updated);
     ...
     * @param microservice
     */
    void onMicroserviceRemoved(IMicroserviceState microservice);
     ...
     * @param tenantEngine
     */
    void onTenantEngineAdded(IMicroserviceState microservice, ITenantEngineState tenantEngine);
     ...
     * @param updated
     */
    void onTenantEngineUpdated(IMicroserviceState microservice, ITenantEngineState previous,
     ...
     * @param tenantEngine
     */
    void onTenantEngineRemoved(IMicroserviceState microservice, ITenantEngineState tenantEngine);
}