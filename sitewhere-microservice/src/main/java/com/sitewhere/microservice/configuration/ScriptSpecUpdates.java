...
public class ScriptSpecUpdates implements IScriptSpecUpdates {
    ...
    /** Indicates if active version was updated */
    private boolean activeVersionUpdated;

    public boolean isActiveVersionUpdated() {
	return activeVersionUpdated;
    }

    public void setActiveVersionUpdated(boolean activeVersionUpdated) {
	this.activeVersionUpdated = activeVersionUpdated;
    }
}
