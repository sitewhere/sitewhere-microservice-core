...
public interface IScriptSynchronizer extends ILifecycleComponent {
     ...
     */
    File getFileSystemRoot() throws SiteWhereException;
     ...
     * @throws SiteWhereException
     */
    Path add(IScriptContext context, ScriptType type, String name, byte[] content) throws SiteWhereException;
     ...
     * @throws SiteWhereException
     */
    Path resolve(IScriptContext context, ScriptType type, String name) throws SiteWhereException;
}