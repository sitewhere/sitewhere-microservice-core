...
public interface IGroovyConfiguration extends ILifecycleComponent {
     ...
     * @return
     */
    IScriptSynchronizer getScriptSynchronizer();
     ...
     */
    Object run(ScriptType type, String name, Binding binding) throws SiteWhereException;
     ...
     * @throws SiteWhereException
     */
    Object run(IScriptMetadata script, Binding binding) throws SiteWhereException;
}